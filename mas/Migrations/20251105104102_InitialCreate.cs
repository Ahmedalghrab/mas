    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 11, 5, 10, 41, 1, 228, DateTimeKind.Utc).AddTicks(2496), "????? ????? ??????? ????????? ??????????", null, "bi bi-file-earmark-text", true, "????? ????? ?????????", "Research & Reports Services" },
                    { 2, new DateTime(2025, 11, 5, 10, 41, 1, 228, DateTimeKind.Utc).AddTicks(2498), "????? ??????? ????????? ??????? ?????????", null, "bi bi-palette", true, "??????? ?????????", "Graphic Design" },
                    { 3, new DateTime(2025, 11, 5, 10, 41, 1, 228, DateTimeKind.Utc).AddTicks(2499), "????? ??????? ?????? ???????? ???????", null, "bi bi-code-slash", true, "??????? ????????", "Programming & Development" },
                    { 4, new DateTime(2025, 11, 5, 10, 41, 1, 228, DateTimeKind.Utc).AddTicks(2500), "????? ??????? ?????????? ?????????", null, "bi bi-translate", true, "???????", "Translation" }
                });
